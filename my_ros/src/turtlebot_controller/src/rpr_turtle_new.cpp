...
void turtleCallback(const turtlesim::Pose::ConstPtr& msg)
{
	...
	*/
	...
	my_srv::ArmonicVel arm_vel;
	arm_vel.request.x = msg->x;
	...
	if (msg->x > 9.0){
		...
		client3.call(arm_vel);
		my_vel.linear.x = arm_vel.response.vel;
...
int main (int argc, char **argv)
{
	...
	//system
	ros::init(argc, argv, "rpr_turtle_arm");
	ros::NodeHandle nh;
	...
	client1.call(srv1);
	client3 = nh.serviceClient<my_srv::ArmonicVel>("/armonicvelocity");
